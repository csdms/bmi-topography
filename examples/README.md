...
* [config.yaml](./config.yaml): A configuration file used to pass parameters to the Topography BMI (and optionally to the CLI).
* [bmi-topopgraphy_config_ex.sh](./bmi-topopgraphy_config_ex.sh) A shell script that demonstrates the `--config-file` CLI option.
